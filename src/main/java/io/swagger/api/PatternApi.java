...
public interface PatternApi {
    ...
    @Operation(summary = "Use user-defined protein pattern e.g. [LIVM]-[VIC]-x(2)-G-[DENQTA]-x-[GAC]-x(2)-[LIVMFY](4)-x(2)-G to match against UniProtKB", description = "Gets a list of proteins that match to the query pattern and other search criteria.", tags={ "API Access Paths" })
    @ApiResponses(value = { 
