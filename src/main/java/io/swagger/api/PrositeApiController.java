...
public class PrositeApiController implements PrositeApi {
	
	@Autowired
	public Environment env;

    private static final Logger log = LoggerFactory.getLogger(PrositeApiController.class);
