...
@Validated
public interface PrositeApi {

    @Operation(summary = "Use PROSITE accession e.g. PS00016 or identifier e.g. BIOTINto match against UniProtKB", description = "Gets a list of proteins that match to the query prosite ac/id and other search criteria.", tags={ "API Access Paths" })
    @ApiResponses(value = { 
