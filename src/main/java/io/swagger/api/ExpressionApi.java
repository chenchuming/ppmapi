...
public interface ExpressionApi {
    ...
    @Operation(summary = "Use combination of PROSITE accessions/identifiers and your own pattern e.g. PS00004 and [RK](2)-x-[ST]-T-D or BIOTIN to match against UniProtKB", description = "Gets a list of proteins that match to the query expression and other search criteria.", tags={ "API Access Paths" })
    @ApiResponses(value = { 
